    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload a CSV file to import multiple buyer leads at once. Maximum
            200 rows per import.
          </CardDescription>
        </CardHeader>
          ...
          <Alert>
            <AlertDescription>
              ...
              <ul className="mt-2 list-disc list-inside space-y-1 text-sm">
                <li>
                  Required columns: fullName, phone, city, propertyType,
                  purpose, timeline, source
                </li>
                <li>
                  BHK is required only for Apartment and Villa property types
                </li>
                <li>
                  Budget values should be in INR (e.g., 5000000 for 50 lakhs)
                </li>
      ...
      {importResult && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {importResult.validRows.length} valid rows,{" "}
