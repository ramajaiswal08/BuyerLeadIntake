...
CREATE TABLE "buyer_history" (
	"id" uuid PRIMARY KEY DEFAULT 'cjabn1b6yhezxh316c80eryx' NOT NULL,
...
CREATE TABLE "buyers" (
	"id" uuid PRIMARY KEY DEFAULT 'g6aqtjtve3efm1klmxhgpyng' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" uuid PRIMARY KEY DEFAULT 'jmq0i133wisqn0481udoec0w' NOT NULL,
